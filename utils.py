...
class Seq2SeqDataset(AbstractSeq2SeqDataset):
    ...
    def __getitem__(self, index) -> Dict[str, str]:
        ...
        # here add truncation from right
        encoded_source_line = self.tokenizer(source_line)["input_ids"][-self.max_source_length:]
        source_line = self.tokenizer.decode(encoded_source_line)
