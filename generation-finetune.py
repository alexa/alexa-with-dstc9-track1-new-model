...
class SummarizationModule(BaseTransformer):
    ...
    def __init__(self, hparams, **kwargs):
        ...
        super().__init__(hparams, num_labels=None, mode=hparams.task, **kwargs)
...
def main(args, model=None) -> SummarizationModule:
    ...
    # ckpt = pl_load(args.output_dir+'/best_tfmr/pytorch_model.bin', map_location=lambda storage, loc: storage)
